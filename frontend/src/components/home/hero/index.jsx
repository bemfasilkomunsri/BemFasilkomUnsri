  ...
  return (
    ...
    >
      ...
      <h2 className="text-base md:text-3xl font-gotham-bold text-black mb-2">
        Bersua Dalam <span className="text-[#8902ff]">Suara</span> Bergerak Dalam Satu{" "}
        <span className="text-[#8800ff] font-semibold">Arah</span>
      </h2>
      ...
      <p className="max-w-3xl font-gotham-book text-sm md:text-lg text-[#3E3E3E] leading-relaxed mb-8">
        Sebagai wadah aspirasi mahasiswa, BEM Fasilkom UNSRI hadir untuk
